...
![Image](./images/sudo_sytemctl_status.png)
...
We will create a database named *Adeboye_DB* and a user named *Adeboye*, but you can replace these names with different values.
